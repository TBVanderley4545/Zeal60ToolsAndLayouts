...
KC_APP   KC_LGUI  KC_LALT  KC_NO    KC_NO    KC_NO    KC_NO    KC_SPC   KC_NO    KC_NO    KC_NO    KC_RALT  KC_RGUI  FN_MO23   

zeal60 keymap 1 ^
KC_PWR   KC_F1    KC_F2    KC_F3    KC_F4    KC_F5    KC_F6    KC_F7    KC_F8    KC_F9    KC_F10   KC_F11   KC_F12   KC_INS  ^
KC_CAPS  KC_MPRV  KC_MNXT  KC_MPLY  KC_TRNS  KC_TRNS  KC_TRNS  KC_TRNS  KC_PSCR  KC_SLCK  KC_PAUS  KC_UP    KC_TRNS  KC_TRNS ^
