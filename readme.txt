Extract "zeal60.exe" along with your preferred .bat layout to desktop before programming your Zeal60 PCB. 
Zeal60s come pre-flashed with the default ANSI 60% layout, so you can get right into mapping your keys & LEDs. 

- Program "zeal60_default.hex" using Flip
- Disconnect USB
- Connect USB
- Double-click on one of the "zeal60_keymap_*.bat" files to program a layout
- .bat files can be edited with your preferred text editor. Simply right click, and edit. Rembmer to save your modifications before closing the file. 
